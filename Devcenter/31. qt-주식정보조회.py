...
class MainWindow(QMainWindow):
    def __init__(self, loop=None):
        ...
        self.btn_reqInfo = QPushButton("Request Info", self)
        self.btn_chart = QPushButton("Request Chart", self)
        ...
        layout.addWidget(self.btn_reqInfo)
