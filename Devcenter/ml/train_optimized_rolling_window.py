...
def train_optimized_rolling_window():
    """최적 롤링 윈도우 모델 학습"""
    print("=" * 80)
    print("최적 롤링 윈도우 모델 학습")
    print("=" * 80)
    ...
    # 모델 저장
    model_path = MODELS_DIR / "trade_filter_xgboost_rolling_optimized.json"
    model.save_model(str(model_path))
    print(f"\n최적 롤링 윈도우 모델 저장 완료: {model_path}")
    
    return model, best_threshold, best_pnl


if __name__ == "__main__":
    model, best_threshold, best_pnl = train_optimized_rolling_window()
