...
**실매매 시뮬레이션 수익률 (임계값 0.6, 3계약 기준):**
- 연간 수익률: 1.52%
- 은행 정기예금 이자율: 연 3-4%

**결론:** 실매매 수익률 1.52%는 은행 이자율보다 낮습니다.

#### 24.8.2 거래 빈도 분석

**임계값별 월평균 매매일 수 (1년 기준):**
...
- 한달 영업일: 약 20-22일
- 매매 신호 발생: 약 2-3일
- 매매 신호 미발생: 약 17-20일 (80-90%)
- 한달의 80-90%는 매매 신호가 발생하지 않음
...
#### 24.8.3 포지션 사이즈와 시장 영향력

**10계약 진행 시 문제점:**
- 이론적 수익: 약 5,070,740원 (1,521,221원 ÷ 3 × 10)
- 시장 영향력: 10계약은 시장에 큰 영향을 미침
- 슬리피지: 실제 주문 시 슬리피지 발생
- 체산 불가능: 불리한 가격 체결 가능성
- 성과 악화: 3계약 백테스트에서 -53M 손실 발생

**결론:** 10계약은 권장하지 않음. 1계약부터 시작하여 점진적으로 포지션을 늘리는 것을 추천.

#### 24.8.4 장단점 분석

**장점:**
- 샤프 비율 3.2719: 리스크 대비 수익성 매우 우수
- 승률 73.33%: 거래의 73%가 수익
- 인트라데이 트레이딩: 하루 내에 청산으로 자금 회전 빠름
- 시장 상관성 낮음: 은행 이자와 무관한 수익원

**단점:**
- 수익률 낮음: 은행 이자(3-4%)보다 낮은 1.52%
- 거래 빈도 낮음: 한달 2-3일만 매매
- 자본 효율성 낮음: 대부분 시간 자금 휴면
- 절대 수익률 낮음: 은행 이자보다 낮음
